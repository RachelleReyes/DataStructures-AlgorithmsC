...
int main() {
    ...
    char resp, * numero, maxNum[11]={0}, binario[32]={0}; //maxNum(variable para el número máximo de int), binario (número binario convertido)
    int max = INT_MAX, i=0;
...
//Procedimiento que captura el numero
void capturarNumero(char * numero){
    char dato;
    int i=0;
